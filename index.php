        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                while($guru = mysqli_fetch_array($query)) {
                    ...
                    echo "<td>
                    <a href='kelola.php?edit=" . $guru['id_guru'] . "' class='btn btn-warning'>Edit</a>
                    <a href='proses.php?hapus=" . $guru['id_guru'] . "' class='btn btn-danger'>Delete</a>
                          </td>";
                    echo "</tr>";
                }
                ?>
